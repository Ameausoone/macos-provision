...
# To pull floating tags (fetch + reset avoids "rebase onto multiple branches" with pull.rebase=true)
alias glf='git fetch origin $(git rev-parse --abbrev-ref HEAD) && git reset --hard FETCH_HEAD'
